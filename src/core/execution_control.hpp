...
class ExecutionControl {
 ...
 protected:
  ...
  virtual RWMutex *CreateRWMutex() { return new SemRWMutex(4, CreateMutex()); }
  ...
  virtual void HandleFree(FreeContext *free);
  virtual void HandleValloc(VallocContext *context);
  virtual void HandleAfterCall(Inst *inst, ADDRINT ret_pc);
  virtual void HandleBeforeRet(ADDRINT target_pc);
 ...
 private:
  ...
  static void __AfterCall(Inst *inst, ADDRINT ret_pc);
  static void __BeforeRet(ADDRINT target_pc);
