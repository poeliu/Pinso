// File: delta/randsched_profiler_main.cpp - The main entrance of the delta idioms profiler.

#include "delta/randsched_profiler.hpp"

#include <csignal>

static delta::RandSchedProfiler *prof_ctrl = new delta::RandSchedProfiler;
